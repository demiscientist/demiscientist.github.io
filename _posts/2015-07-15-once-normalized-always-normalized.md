...
By normalizing the wave function we want to solve for the unknown constant A. In a normalized function, the probability of finding the particle between $$x$$ and $$x+dx$$, $$\displaystyle{ \left|\Psi(x)\right|^2dx }$$,
